    ...
    public void startElement(String name, AttributeList attrs) {
        switch (getTag(name)) {
            ...
            case DATABASE:
                ...
                if(root == null)// 19.11.2022 - del my comm
                root = dtab.getRoot();
...
//        System.out.println("<attr-list name=" + node.getName());
            ...
            case ATTR:
                ...
                if(attr==null) {
                    attr = new Attribute(id, attrs.getValue("name"), getType(attrs.getValue("type")));
...
//                    XLSXDataFactory.out(dtab);
                ...
                if (root.getParent() != null)//my comm
                    root = root.getParent();//my comm
